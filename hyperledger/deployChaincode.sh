...
chaincodeInvoke() {
    ...
    # peer chaincode upgrade -o localhost:7050 -C mychannel -n ${CC_NAME} -v 1.1 -c '{"Args":["init","a","100","b","200","c","300"]}' -P "AND ('Org1MSP.peer','Org2MSP.peer')"
    # Create Car
    # peer chaincode invoke -o localhost:7050 \
    #     --ordererTLSHostnameOverride orderer.example.com \
    ...
    #     --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
    #     -c '{"function": "approveTokenRequest","Args":["1234", "johnnie", "12345", "invoke"]}'
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        -c '{"function": "approveTokenRequest","Args":["1234", "ashish", "9","hmmm" ] }'
...
#         --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
#         --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
#         -c '{"function": "approveTokenRequest", "Args":["1234","john","12345","invoked from chaincode"]}'
 }
